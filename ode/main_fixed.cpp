...
#include "dopr5_dtau_limit.hpp"  // Using recommended method
#include "init.hpp"
#include "photon.hpp"
#include "ran.hpp"
...
// IMPORTANT: Using dtau_max = 0.01 to prevent resonance layer skipping
// See RESONANCE_FIX_REPORT.md for details
constexpr double dtau_max = 0.01;
...
int main() {
  ...
  // Using StepperDopr5DtauLimit with dtau_max = 0.01
  // This prevents resonance layer skipping with minimal overhead
