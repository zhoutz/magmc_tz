...
int main(int argc,char **argv) {
  ...
  return benchmark_main(argc,argv,"transport_fast",[&](auto const &field,auto const &c,auto const &cfg,auto const &) {
    Boltzmann fb(c.b0);
  ...
  },defaults," geometry_rtol=1e-9 geometry_atol=1e-10 quadrature_atol=0.01*tolerance initial_step_policy=parameter*r_or_target_bound tail_u=12 split_field_knots=false guard_extremum_bounds=false");
}
